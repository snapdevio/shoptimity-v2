...
async function main() {
  ...
  const featuresData = [
    ...
    { category: "widgets", name: "Mega Menu", slug: "mega-menu", position: 19 },
    {
      category: "widgets",
      name: "Music Player",
      slug: "music-player",
    ...
    { category: "widgets", name: "Reviews", slug: "reviews", position: 33 },
    {
      category: "widgets",
    ...
    { category: "widgets", name: "Slider", slug: "slider", position: 37 },
    {
      category: "widgets",
    ...
    { category: "widgets", name: "Wishlist", slug: "wishlist", position: 46 },
    {
    ...
    { category: "sections", name: "Collage", slug: "collage", position: 64 },
    {
      category: "sections",
    ...
    { category: "sections", name: "Icon Bar", slug: "icon-bar", position: 87 },
    {
      category: "sections",
    ...
    { category: "sections", name: "Multirow", slug: "multirow", position: 97 },
    {
      category: "sections",
    ...
    { category: "sections", name: "Page", slug: "page", position: 99 },
    {
      category: "sections",
    ...
    { category: "sections", name: "Results", slug: "results", position: 105 },
    {
      category: "sections",
      name: "Review Grid",
      slug: "review-grid",
    ...
    { category: "sections", name: "Timeline", slug: "timeline", position: 117 },
    {
      category: "sections",
    ...
    { category: "sections", name: "Video", slug: "video", position: 121 },
  ]
