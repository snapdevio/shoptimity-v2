 ...
 */
export const DiscordIcon = forwardRef<SVGSVGElement, BrandIconProps>(
 ...
 */
export const XIcon = forwardRef<SVGSVGElement, BrandIconProps>(
 ...
 */
export const LinkedinIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ size = 20, className, ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
 ...
 */
export const YoutubeIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ size = 20, className, ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
 ...
 */
export const InstagramIcon = forwardRef<SVGSVGElement, BrandIconProps>(
  ({ size = 20, className, ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
